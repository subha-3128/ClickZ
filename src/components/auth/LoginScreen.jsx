      ...
      <div className="login-card">
        <header className="login-header">
          <div className="login-logo-wrap">
            <img src="/pwa-512.png" alt="ClickZ Logo" className="login-logo" />
          </div>
          <h1>ClickZ</h1>
          <p className="tagline">Minimal, fast & secure bookmark manager</p>
        </header>

        <p className="login-description">
          Organize, search, and access all your essential links instantly in a clean, distraction-free workspace.
        </p>
